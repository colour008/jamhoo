...
下载后安装：`Hack Bold Italic Nerd Font Complete Mono Windows Compatible` 注意是带有 `Compatible` 字样的字体

**个人推荐使用**：[FiraCode/Regular](https://github.com/ryanoasis/nerd-fonts/tree/master/patched-fonts/FiraCode/Regular/complete/) 里面的第一个
...
此时，输入 `ls` 可以看到目录下的文件都有了 icon 图标

[![微信截图_20220320135519](https://bu.dusays.com/2025/01/28/67984f03b8478.png)](https://user-images.githubusercontent.com/25282180/159150188-bd07fd78-7e92-43ea-849d-6c59274fa441.png)
...
个人习惯，喜欢使用字母 j 代替 `z`，配置 `$PROFILE` 如下：
...
- [github/PSReadLine](https://github.com/PowerShell/PSReadLine) 主要用于记忆命令历史、展示命令列表、快捷键等，参考 readme

快捷键（使用效果和 linux 的 terminal 一样）：
...
配置完成后，命令行输入：`ins` 命令，应该会有提示 历史输入过的命令

[![QQ图片20220320135815](https://bu.dusays.com/2025/01/28/67984f005d262.png)](https://user-images.githubusercontent.com/25282180/159150299-ac8f8036-dc8a-4988-8af9-b906c731d704.png)
...
输入命令后，按 快捷键 `Ctr + f` 或 `Ctrl + r` 搜索相关文件

[![QQ截图20220320135228](https://bu.dusays.com/2025/01/28/67984efde181c.jpg)](https://user-images.githubusercontent.com/25282180/159150125-64c93619-a325-4107-b61e-47e8f74bde88.jpg)
...
更多内容，参考作者的配置文件：https://github.com/Jsmond2016/blog/issues/19
